...
| Option | Description |
|--------|-------------|
| `any` | Match models with any of the specified tags, including untagged models |
| `all` | Match models with all of the specified tags, including untagged models |
| `any_strict` | Match models with any of the specified tags, excluding untagged models |
| `all_strict` | Match models with all of the specified tags, excluding untagged models |
